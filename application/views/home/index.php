...
<head>
    ...
    <link href="<?= base_url('old_assets/'); ?>vendors/css/styles.css" rel="stylesheet" />
    <!--=============== BOXICONS ===============-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container bg-gray">
                        ...
                        <a class="btn-solid-lg" href="<?= base_url('auth'); ?>" style="background-color:#093d77;color:white">Ayo Vote</a>
                    </div>
                    <!-- end of text-container -->
                </div>
                <!-- end of col -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="social-container">
                        <span class="fa-stack">
                            <a href="https://instagram.com/bem.bina_insani?igshid=YmMyMTA2M2Y=" target="_blank">
                                <i class="fas fa-circle fa-stack-2x"></i>
                                <i class="fab fa-instagram fa-stack-1x"></i>
                            </a>
                        </span>
                        <span class="fa-stack">
                            <a href="https://www.youtube.com/channel/UCcXmOz5WThBf9soP0TKrQJA" target="_blank">
                                <i class="fas fa-circle fa-stack-2x"></i>
