                  ...
                  <?php if ($user['status'] != 'Sudah Memilih') { ?>
                      <div class="card">
                          <div class="card-body" style="background-color : #47c363">
                              <br>
                              <br>
                              <h2 class="m-0 font-weight-bold text-center" style="color : white;">SURAT SUARA</h2>
                              <h2 class="m-0 font-weight-bold text-center" style="color : white;">PEMILIHAN RAYA</h2>
                          </div>
                          ...
                          <div class="card-body" style="margin-top: -4rem;">
                              <h2 class="m-0 font-weight-bold text-center" style="color : dark;">DEBAT PASLON KETUA</h2>
                              <h2 class="mb-3 font-weight-bold text-center" style="color : dark;">BEM BIU 2022/2023</h2>
                          </div>
                          <div class="card-body">
                          ...
                          <div class="card-body" style="background-color: #47c363;">
                              ...
                              <h3 class="m-0 font-weight-bold text-center" style="color: white;">TAHUN 2023</h3>
                                      ...
                                      <?php foreach ($paslon as $d) { ?>
                                          <div class="col-sm-12 col-md-6 table-responsive-sm">
                                              <table class="table">
                                                  ...
                                                  <tr>
                                                      <td><img class="img-fluid" style="text-align: center; width: 300px;display:block;height: 300px;" src="<?= base_url('assets/foto/') . $d['gambar1']; ?>"></td>
                                                      <td><img class="img-fluid" style="text-align: center; width: 300px;display:block;height: 300px;" src="<?= base_url('assets/foto/') . $d['gambar2']; ?>"></td>
                                                  </tr>
                                                  <tr>
                                                      <td align="center">
                  ...
                  <?php } else { ?>
                      <div class="card">
                          <div class="card-body" style="background-color : #47c363">
                              <br>
                              <br>
                              <h2 class="m-0 font-weight-bold text-center" style="color : white;">TERIMA KASIH</h2>
                              <h2 class="m-0 font-weight-bold text-center" style="color : white;">SUDAH MENGGUNAKAN HAK PILIH ANDA</h2>
                          </div>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                              <path fill="#47c363" fill-opacity="1" d="M0,96L60,106.7C120,117,240,139,360,138.7C480,139,600,117,720,106.7C840,96,960,96,1080,85.3C1200,75,1320,53,1380,42.7L1440,32L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path>
                          </svg>
