              ...
              <div class="section-body">
                  <?php if ($user['status'] != 'Sudah Memilih') { ?>
                      <div class="card">
                          ...
                          <div class="card-body" style="background-color: #47c363;">
                              <h4 class="m-0 font-weight-bold text-center" style="color: white;">CALON PRESIDEN DAN WAKIL PRESIDEN</h4>
                              <h4 class="m-0 font-weight-bold text-center" style="color: white;">MAHASISWA</h4>
                              <h4 class="m-0 font-weight-bold text-center" style="color: white;">UNIVERSITAS BINA INSANI</h4>
                              <h4 class="m-0 font-weight-bold text-center" style="color: white;">TAHUN 2023</h4>
