                                  ...
                                  <?php foreach ($paslon as $d) { ?>
                                      <div class="col-sm-12 col-md-6 table-responsive-sm">
                                          <table class="table table-hover">
                                              ...
                                              <tr>
                                                  <td><img class="img-fluid" style="max-width: 100%;display:block;height:auto;" src="<?= base_url('assets/foto/') . $d['gambar1']; ?>"></td>
                                                  <td><img class="img-fluid" style="max-width: 100%;display:block;height:auto;" src="<?= base_url('assets/foto/') . $d['gambar2']; ?>"></td>
                                              </tr>
                                              <tr>
                                                  <td align="center">
